...
const ChartPlaceholder = ({ message }) => (
    <div className="bg-gray-700 p-4 rounded-lg flex items-center justify-center h-full min-h-[200px]">
...
const EmotionChart = ({ data }) => {
    ...
    return (
        <div className="bg-gray-700 p-4 rounded-lg">
            <h3 className="text-sm text-gray-400 font-medium mb-4 text-center">Facial Emotion Profile</h3>
...
const FillerWordsChart = ({ data }) => {
    ...
    return (
        <div className="bg-gray-700 p-4 rounded-lg">
            <h3 className="text-sm text-gray-400 font-medium mb-4 text-center">Filler Words Breakdown</h3>
            <ResponsiveContainer width="100%" height={200}>
...
const AudioQualityChart = ({ data }) => {
    ...
    return (
        <div className="bg-gray-700 p-4 rounded-lg">
            <h3 className="text-sm text-gray-400 font-medium mb-4 text-center">Audio Quality</h3>
            <ResponsiveContainer width="100%" height={200}>
...
function App() {
  ...
  const handleGeneratePdf = async () => {
    ...
    reportElement.style.backgroundColor = '#1f2937';
    const canvas = await html2canvas(reportElement, { scale: 2, useCORS: true, backgroundColor: '#1f2937' });
    ...
    <div className="bg-gray-900 text-white min-h-screen flex flex-col items-center justify-center p-4 font-sans">
      <div className="w-full max-w-4xl space-y-8 py-8">
        ...
        <main className="flex flex-col items-center space-y-6">
          ...
          <button onClick={isRecording ? handleStopRecording : handleStartRecording} className={`flex items-center justify-center w-24 h-24 rounded-full text-white font-semibold transition-all duration-300 ease-in-out focus:outline-none focus:ring-4 ${isRecording ? 'bg-red-600 hover:bg-red-700 focus:ring-red-500 animate-pulse' : 'bg-blue-600 hover:bg-blue-700 focus:ring-blue-500'}`}>
          ...
          {isLoading && <p className="text-center">{statusText}</p>}
        </main>
